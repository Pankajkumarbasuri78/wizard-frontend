...
const CheckboxComponent = (props) => {
  ...
  useEffect(() => {
    ...
    // console.log("useeffectmount",checkAllValidation());
    const allCheckBox = selectedComponents.filter((element) => element.type.name === "CheckboxComponent");
    let validationStatus = true;
    allCheckBox.forEach((checkbox) => {const validationValue = validateCheckboxForm({
